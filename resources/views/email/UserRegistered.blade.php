    ...
    <div class="container">
        <div class="wrapper">
            ...
            <div class="main_wrapper">
                <div>
                    <strong>Hii {{ucwords($user->fname." ".$user->lname)}}</strong>
                </div>
                <p>Thank You for Registering at Sheetz. We have received your registration Request.You are now part of Seetz family</p>
